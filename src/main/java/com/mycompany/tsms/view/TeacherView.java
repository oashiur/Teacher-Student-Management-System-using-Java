...
public class TeacherView extends javax.swing.JFrame {
    ...
    public TeacherView(byte[] photo, JButton btnClear, JButton btnDelete, JButton btnSave, JButton btnUpdate, JLabel imageLabel, JPanel jPanel1, JScrollPane jScrollPane1, JLabel labelCell, JLabel labelEmail, JLabel labelHeader, JLabel labelId, JLabel labelName, JTable studentTable, JTextField txtCell, JTextField txtEmail, JLabel txtId, JTextField txtName) throws HeadlessException {
        this.photo = photo;
        ...
        this.teacherTable = studentTable;
    ...
    public TeacherView() throws ClassNotFoundException {
        initComponents();
        TableDataRetrive();
    ...
    public ArrayList<Student> sList() throws ClassNotFoundException {
        ...
        String sqlRetrive = "SELECT * from teacherinfo";
        try {
    ...
    private void initComponents() {
        ...
        studentPanel = new javax.swing.JLabel();
        ...
        labelHeader.setText("Teacher Panel");

        studentPanel.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        studentPanel.setForeground(new java.awt.Color(0, 0, 255));
        studentPanel.setText("Student Panel");
        studentPanel.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        teacherTable.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
    ...
    private void btnSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSaveMouseClicked
        // TODO add your handling code here:
        String sqlSave = "INSERT INTO teacherinfo (name, email, cell, image) VALUES (?,?,?,?)";
        try {
    ...
    private void btnUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMouseClicked
        // TODO add your handling code here:
        String sqlUpdate = "UPDATE teacherinfo SET name = ?, email = ?, cell = ?, image = ? WHERE id = ?";        
        try {            
    ...
    private void btnDeleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDeleteMouseClicked
        // TODO add your handling code here:
        String sqlDelete = "DELETE FROM teacherinfo WHERE id=?";
        try {
    ...
    private javax.swing.JLabel studentPanel;
